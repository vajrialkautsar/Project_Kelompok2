            ...
            <div class="col-lg-5">
              <div class="feature-car-rent-box-1">
                ...
                <div class="d-flex align-items-center bg-light p-3">
                  <span>$150/day</span>
                  <a href="<?php echo base_url()?>assets/assets_shop/contact.html" class="ml-auto btn btn-primary">Rent Now</a>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-9">
            ...
            <div class="nonloop-block-13 owl-carousel">
              <div class="item-1">
                <a href="#"><img src="<?php echo base_url()?>assets/assets_shop/images/img_1.jpg" alt="Image" class="img-fluid"></a>
                <div class="item-1-contents">
                  ...
                  <div class="d-flex action">
                    <a href="<?php echo base_url()?>assets/assets_shop/contact.html" class="btn btn-primary">Rent Now</a>
                  </div>
                </div>
              </div>
    ...
    <div class="site-section section-3" style="background-image: url('<?php echo base_url()?>assets/assets_shop/images/hero_2.jpg');">
      <div class="container">
        <div class="row">
        ...
        <div class="row">
          <div class="col-lg-4 mb-4 mb-lg-0">
            <div class="testimonial-2">
              ...
              <div class="d-flex v-card align-items-center">
                <img src="<?php echo base_url()?>assets/assets_shop/images/person_1.jpg" alt="Image" class="img-fluid mr-3">
          ...
          <div class="col-lg-4 mb-4 mb-lg-0">
            <div class="testimonial-2">
              ...
              <div class="d-flex v-card align-items-center">
                <img src="<?php echo base_url()?>assets/assets_shop/images/person_2.jpg" alt="Image" class="img-fluid mr-3">
          ...
          <div class="col-lg-4 mb-4 mb-lg-0">
            <div class="testimonial-2">
              ...
              <div class="d-flex v-card align-items-center">
                <img src="<?php echo base_url()?>assets/assets_shop/images/person_3.jpg" alt="Image" class="img-fluid mr-3">
        ...
        <div class="row">
          <div class="col-lg-4 col-md-6 mb-4">
            <div class="post-entry-1 h-100">
              <a href="single.html">
                <img src="<?php echo base_url()?>assets/assets_shop/images/post_1.jpg" alt="Image"
                 class="img-fluid">
              </a>
          ...
          <div class="col-lg-4 col-md-6 mb-4">
            <div class="post-entry-1 h-100">
              <a href="single.html">
                <img src="<?php echo base_url()?>assets/assets_shop/images/img_2.jpg" alt="Image"
                 class="img-fluid">
              </a>
              <div class="post-entry-1-contents">
                <h2><a href="single.html">The best car rent in the entire planet</a></h2>
          ...
          <div class="col-lg-4 col-md-6 mb-4">
            <div class="post-entry-1 h-100">
              <a href="single.html">
                <img src="<?php echo base_url()?>assets/assets_shop/images/img_3.jpg" alt="Image"
                 class="img-fluid">
              </a>
              <div class="post-entry-1-contents">
                <h2><a href="single.html">The best car rent in the entire planet</a></h2>
